...
- [ ] **UAT-GAP-04** — Cross-document navigation produces no AbortError in DevTools console. BaseLayout.astro head registers pageswap handler with .finished.catch; handler is is:inline AND in head (registers before first link click); MOTION.md §5 MOTN-01 documents the rejection-handling contract. *Plan 17-10 — pending.*
