...
- [ ] 25-00-PLAN.md — Phase-25 invariant baseline: `verify-phase25-invariants.mjs` + `25-BASELINE.json` hashing the four D-14 gated files + normalized deps at phase start, so 25-04 proves phase-wide untouched against committed drift (QA-01/QA-02) — added in the --reviews replan per Codex mandatory correction #4
...
| 25. Chat Knowledge Refresh & Milestone Verification | v1.4 | 0/5 | Not started | - |
