...
**In flight:** v1.4 Professional Experience — all 5 phases complete and verified (Phase 21 Experience pipeline + Phase 22 Experience page & Holloway case study + Phase 23 Projects reconciliation & featured tier + Phase 24 Positioning shift & Home teaser + Phase 25 Chat knowledge refresh & milestone verification); ready to ship — production deploy + edge Lighthouse gate pending at `/gsd-ship`
