...
## `sync-experience exports`

- **method:** EXPORT
- **path:** scripts/sync-experience.mjs
- **params:** 
- **file:** scripts/sync-experience.mjs
- **description:** Source-of-truth sync CLI + testable helpers: normalize (CRLF->LF), readSourceField (parse frontmatter source:), sliceFrontmatter (split frontmatter/body), extractFence (pull CASE-STUDY fenced block). Extracts fenced case-study prose from Experience/*.md into src/content/experience/*.mdx bodies; --check mode is the CI drift gate.
